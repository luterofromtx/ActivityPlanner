...
struct qt_meta_stringdata_CLASSNotificationsENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSNotificationsENDCLASS = QtMocHelpers::stringData(
    "Notifications",
    "on_CloseBtn_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSNotificationsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Notifications::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSNotificationsENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSNotificationsENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNotificationsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Notifications::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSNotificationsENDCLASS.stringdata0))
