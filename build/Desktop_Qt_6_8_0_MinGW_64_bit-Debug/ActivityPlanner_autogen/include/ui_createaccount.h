...
public:
    ...
    void setupUi(QDialog *CreateAccount)
    {
        ...
        layoutWidget->setGeometry(QRect(60, 50, 261, 149));
        ...
        lineEditConfirm->setEchoMode(QLineEdit::EchoMode::Password);
    ...
    void retranslateUi(QDialog *CreateAccount)
    {
        ...
        BackBtn->setText(QCoreApplication::translate("CreateAccount", "Cancel", nullptr));
