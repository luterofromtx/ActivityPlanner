...
public:
    ...
    void setupUi(QDialog *MainTaskScreen)
    {
        ...
        LogoutBtn->setGeometry(QRect(800, 450, 75, 24));
        calendarWidget = new QCalendarWidget(MainTaskScreen);
        calendarWidget->setObjectName("calendarWidget");
        calendarWidget->setGeometry(QRect(600, 230, 312, 190));
        ...
        SwitchUserBtn->setGeometry(QRect(640, 450, 75, 24));
    ...
    void retranslateUi(QDialog *MainTaskScreen)
    {
        ...
        label_4->setText(QCoreApplication::translate("MainTaskScreen", "Username:", nullptr));
