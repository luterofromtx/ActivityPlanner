...
public:
    ...
    void setupUi(QDialog *MainTaskScreen)
    {
        ...
        tableWidget->setGeometry(QRect(0, 20, 551, 271));
        ...
        TaskDeadlineT = new QLabel(groupBox_2);
        TaskDeadlineT->setObjectName("TaskDeadlineT");
        TaskDeadlineT->setGeometry(QRect(190, 100, 151, 31));
        TaskNameT = new QLabel(groupBox_2);
        TaskNameT->setObjectName("TaskNameT");
        TaskNameT->setGeometry(QRect(20, 100, 151, 31));
        line = new QFrame(groupBox_2);
        line->setObjectName("line");
        line->setGeometry(QRect(0, 30, 511, 16));
        ...
        CompletedT = new QLabel(groupBox_3);
        CompletedT->setObjectName("CompletedT");
        CompletedT->setGeometry(QRect(390, 26, 81, 21));
        TaskNameT2 = new QLabel(groupBox_3);
        TaskNameT2->setObjectName("TaskNameT2");
        TaskNameT2->setGeometry(QRect(20, 30, 151, 21));
        TaskDeadlineT2 = new QLabel(groupBox_3);
        TaskDeadlineT2->setObjectName("TaskDeadlineT2");
        TaskDeadlineT2->setGeometry(QRect(190, 30, 141, 21));
    ...
    void retranslateUi(QDialog *MainTaskScreen)
    {
        ...
        TaskDeadlineT->setText(QString());
        TaskNameT->setText(QString());
        groupBox_3->setTitle(QCoreApplication::translate("MainTaskScreen", "Completed Tasks", nullptr));
        CompletedT->setText(QString());
        TaskNameT2->setText(QString());
        TaskDeadlineT2->setText(QString());
